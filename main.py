...
def main(model_name, batch_size, epochs, learning_rate, conv_algo, performance, eval_only, use_gpu):
    ...
    if model_name == 'AlexNet':
        ...
        model = OIANET_CIFAR100(conv_algo=conv_algo, use_gpu=use_gpu)
    else:
...
if __name__ == '__main__':
    ...
    main(model_name, batch_size, epochs, learning_rate, conv_algo, performance, eval_only, use_gpu=use_gpu)